...
scenario = Scenario(name="HeadMaster Demo", num_asteroids=12, ship_states=ship_states, map_size=(W, H), time_limit=600.0)


# HeadMaster : 2 en black box toutes les 5 sec
hm = HeadMaster(top_k=2, interval_s=2.0, w_dist=1.0, w_approach=1.0)

# Un HybridController par vaisseau
